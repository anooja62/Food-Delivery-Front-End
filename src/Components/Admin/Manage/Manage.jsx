...
const Manage = ({ restaurant }) => {
  ...
  return (
    <>
      <tbody>
        <tr>
          <td className="text-center" style={{ paddingTop: "2%" }}>{restaurant.name}</td>
          <td className="text-center" style={{ paddingTop: "2%" }}>{restaurant.email}</td>
          <td className="text-center" style={{ paddingTop: "2%" }}>{restaurant.phone}</td>
          <td className="text-center" style={{ paddingTop: "2%" }}>{restaurant.address}</td>
