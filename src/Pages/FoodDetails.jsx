          ...
          <div className="tabs d-flex align-items-center gap-5 py-3">
            ...
            <form className='form' onSubmit={submitHandler}>
               <div className='form__group'>
                <input type='text' placeholder='Enter your name' onChange={e=>setEnteredName(e.target.value)} required></input>
               </div>
               <div className='form__group'>
                <input type='text' placeholder='Enter your email' onChange={e=>setEnteredEmail(e.target.value)} required></input>
               </div>
               <div className='form__group'>
                <textarea
                rows={5}
                 type='text' placeholder='Write your review' onChange={e=>setReviewMsg(e.target.value)} required></textarea>
               </div>
